...
int inputs::loadClutter(char *filename, double radius, struct site tx)
{
...
void inputs::readLIDAR(FILE *fd, int h, int w, int indx,double n, double e, double s, double west)
{
...
int inputs::loadLIDAR(char *filenames)
{
	char *filename;
...
int inputs::LoadSDF_SDF(char *name)
{
...
void inputs:: LoadPAT(char *filename)
{
...
void inputs::LoadSignalColors(struct site xmtr)
{
	int x, y, ok, val[4];
...
void inputs::LoadLossColors(struct site xmtr)
{
	int x, y, ok, val[4];
	char filename[255], string[80], *pointer = NULL, *s = NULL;
	FILE *fd = NULL;
...
void inputs::LoadDBMColors(struct site xmtr)
{
	int x, y, ok, val[4];
	char filename[255], string[80], *pointer = NULL, *s = NULL;
	FILE *fd = NULL;
...
void inputs::LoadTopoData(int max_lon, int min_lon, int max_lat, int min_lat)
{
...
void inputs::LoadUDT(char *filename)
{
